...
SOURCE: https://github.com/felixchenfy/open3d_ros_pointcloud_conversion
...
# From: https://github.com/felixchenfy/3D-Scanner-by-Baxter/blob/master/src_python/lib_cloud_conversion_between_Open3D_and_ROS.py
FIELDS_XYZRGB = FIELDS_XYZ + \
    [PointField(name='rgb', offset=12, datatype=PointField.UINT32, count=1)]


# Bit operations
BIT_MOVE_32 = 2**32 #my add
BIT_MOVE_16 = 2**16
BIT_MOVE_8 = 2**8
...
#Be very  careful with the ROS frame_id! It's adviced to make a simple test o3d->ROS and back to visualize on RVIZ the 2 pointclouds
def convertCloudFromOpen3dToRos(open3d_cloud, frame_id):
    ...
    if not open3d_cloud.colors: # XYZ only
        ...
        # I had to change this portion of code!!! Color transformation was not equal to the input colors!
        # Suggestions here: https://gist.github.com/lucasw/ea04dcd65bc944daea07612314d114bb

        # -- Change rgb color from "three float" to "one 24-byte int"
        # 0x00FFFFFF is white, 0x00000000 is black.
        
        colors = np.asarray(open3d_cloud.colors) # nx3 matrix
    ...
    return pc2.create_cloud(header, fields, new_points)
